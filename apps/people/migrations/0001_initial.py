...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PrjStudy'
        db.create_table('people_prjstudy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('projects', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('join_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('people', ['PrjStudy'])


    def backwards(self, orm):
        
        # Deleting model 'PrjStudy'
        db.delete_table('people_prjstudy')
    ...
    models = {
        ...
        'people.prjstudy': {
            ...
            'projects': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
