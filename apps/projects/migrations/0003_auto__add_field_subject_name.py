...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.name'
        db.add_column('projects_subject', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subject.name'
        db.delete_column('projects_subject', 'name')
